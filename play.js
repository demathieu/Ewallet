...
// var test = new policy({filter:function(){return false}}).whiteList()

// function filterChain(filterList){
// 	filterValue = true;
// 	var i = 0;
// 	while(filterValue && i < filterList.length){
// 		filterValue = filterList[i].filter();
// 		i++;
// 	}
// 	return filterValue;
// }

// function filterChainOR(filterList){
// 	filterValue = false;
// 	var i = 0;
// 	while(!filterValue && i < filterList.length){
// 		filterValue = filterList[i].filter();
