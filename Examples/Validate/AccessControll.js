...
//------------------------------------------------------------------------------- 
var aliceSafe = new policyBuilder.policy(c.whiteListAccesControl).allow('lastname').install(alice);
...
var aliceSafe = new policyBuilder.policy(state).allow('lastname').install(alice);
